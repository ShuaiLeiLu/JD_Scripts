...
!(async () => {
  ...
  $.shareUuid = "e682badd53284eb08ea1bb2356dc7b68"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/may/brandUnion/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = ["e682badd53284eb08ea1bb2356dc7b68","c77f35c3c7bb4b7fa0e95af26e16b91c","034df84ea6d842f19056d27a628a61d7"]
  ...
  switch (type) {
    case 'isvObfuscator':
      ...
      case 'info':
        ...
        break;
      case 'startDraw':
        url = `${domain}/dingzhi/may/brandUnion/startDraw`;
        body = `activityId=${$.activityId}&pin=${encodeURIComponent($.Pin)}&actorUuid=${$.actorUuid}`
        break;
      case 'followShop':
        url = `${domain}/dingzhi/may/brandUnion/saveTask`;
      ...
      case 'getShareRecord':
        ...
        break;
      case 'getRule':
        url = `${domain}/dingzhi/may/brandUnion/getRule`;
        body = `activityId=${$.activityId}`
        break;
      case '抽奖':
