...
[task_local]
#5.27-5.30 品类联合
50 14 27-30 5 * jd_opencardL161.js, tag=2.18-2.28 联合关注, enabled=true

*/
const $ = new Env('5.27-5.30 品类联合');
...
!(async () => {
  ...
  $.shareUuid = "745415bbe6bf43ff990f4b17e8dbbc3c"
  $.venderIds = "599119"
  console.log(`入口:\nhttps://lzdz-isv.isvjcloud.com/categoryUnion/activity?activityId=${$.activityId}&tplId=0003&friendid=${$.shareUuid}`)
  let shareUuidArr = ["745415bbe6bf43ff990f4b17e8dbbc3c","a8f4235d573544868fc61211dbdc5f72"]
