...
————————————————
入口：[组队分豆-新安怡 (https://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=7dee74f982034f5496a469ecdb4b05f2&signUuid=1259ded5bc5a4b2f8a6efac9ad189e77)]
IOS等用户直接用NobyDa的jd cookie
============Quantumultx===============
[task_local]
#组队分豆-新安怡
18 3,17 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_xay.js, tag=组队分豆-新安怡, enabled=true
================Loon==============
[Script]
cron "18 3,17 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_xay.js,tag=组队分豆-新安怡
===============Surge=================
组队分豆-新安怡 = type=cron,cronexp="18 3,17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_xay.js
============小火箭=========
组队分豆-新安怡 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_xay.js, cronexpr="18 3,17 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=7dee74f982034f5496a469ecdb4b05f2&signUuid=1259ded5bc5a4b2f8a6efac9ad189e77`)
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['1259ded5bc5a4b2f8a6efac9ad189e77','c3fb978df85c4cd6baf92a69ac909ecf','bd0643a8914a48f5a545b0b3e080f702']
            $.bean = 0;
            ...
            if ($.activityContent) {
                if ($.activityContent.canJoin) {
                    ...
                    if (!$.activityContent.openCard) {
						await $.wait(1500)
                        await getShopOpenCardInfo({ "venderId": "1000002527", "channel": 401 }, 1000003691)
                        await bindWithVender({ "venderId": "1000002527", "shopId": "1000002527", "bindByVerifyCodeFlag": 1, "registerExtend": {}, "writeChildFlag": 0, "activityId": 3282318, "channel": 401 }, 1000003691)
                    }
                    await $.wait(1500)
