...
async function doDailyTask() {
    ...
    if (!$.farmTask.gotBrowseTaskAdInit.f) {
        ...
        for (let advert of adverts) {
            ...
            $.browseResult = await doApi("browseAdTaskForFarm", {
            ...
            if ($.browseResult.code === "0") {
                ...
                //领取奖励
                $.browseRwardResult = await doApi("browseAdTaskForFarm", {
                    advertId: advert.advertId,
                    type: 1,
                    version,
                    channel: 1,
...
async function doTenWaterAgain() {
    ...
    if (totalEnergy >= 100 && doubleCard > 0) {
        ...
        for (let i = 0; i < new Array(doubleCard).fill("").length; i++) {
            $.userMyCardRes = await doApi("userMyCardForFarm", {
                cardType: "doubleCard",
                type: "",
                version,
                channel: 1,
...
function gotStageAward() {
    return new Promise(async (resolve) => {
        if ($.waterResult.waterStatus === 0 && $.waterResult.treeEnergy === 10) {
            ...
            $.gotStageAwardForFarmRes = await doApi("gotStageAwardForFarm", {
                type: "1",
                version,
                channel: 1,
                babelChannel: 0
...
async function turntableFarm() {
    ...
    if ($.initForTurntableFarmRes.code === "0") {
        ...
        for (let code of newShareCodes) {
            ...
            $.lotteryMasterHelpRes = await doApi("initForFarm", {
                shareCode: code + "-3",
                sid,
                version,
                channel: 1,
        ...
        if ($.farmAssistResult.assistFriendList && $.farmAssistResult.assistFriendList.length >= 2) {
            if ($.farmAssistResult.status === 2) {
                ...
                for (let key of Object.keys($.farmAssistResult.assistStageList)) {
                    ...
                    if (vo.stageStaus === 2) {
                        $.receiveStageEnergy = await doApi("receiveStageEnergy", {
                            version,
                            channel: 1,
                            babelChannel: "121"
                        }, 0);
...
async function masterHelpShare() {
    ...
    for (let code of newShareCodes) {
        ...
        $.helpResult = await doWxApi("initForFarmWX", {
            shareCode: code,
            mpin: "",
            imageUrl: "",
            nickName: "",
...
async function clockInIn() {
    ...
    $.clockInInit = await doApi("clockInInitForFarm", {
        timestamp: Date.now(),
        version,
        channel: 1,
        babelChannel: "121"
        ...
        if (!$.clockInInit.todaySigned) {
            ...
            if ($.clockInForFarmRes.code === "0") {
                ...
                if ($.clockInForFarmRes.signDay === 7) {
                    ...
                    $.gotClockInGiftRes = await doApi("clockInForFarm", {
                        type: 2,
                        version,
                        channel: 1,
                        babelChannel: "121"
    ...
    if ($.friendList) {
        ...
        if ($.friendList.friends && $.friendList.friends.length > 0) {
            for (let friend of $.friendList.friends) {
                ...
                const deleteFriendForFarm = await doApi("deleteFriendForFarm", {
        ...
        if ($.friendList.inviteFriendCount > 0) {
            if ($.friendList.inviteFriendCount > $.friendList.inviteFriendGotAwardCount) {
                ...
                $.awardInviteFriendRes = await doApi("awardInviteFriendForFarm", {
                    version,
                    channel: 1,
                    babelChannel: "121"
                }, 0);
    ...
    if (waterFriendCountKey < waterFriendMax) {
        ...
        if ($.friendList.friends && $.friendList.friends.length > 0) {
            ...
            for (let index = 0; index < needWaterFriends.length; index++) {
                $.waterFriendForFarmRes = await doApi("waterFriendForFarm", {
                    shareCode: needWaterFriends[index],
                    version,
                    channel: 1,
                    babelChannel: "121"
                }, 0);
...
async function getWaterFriendGotAward() {
    ...
    if (waterFriendCountKey >= waterFriendMax) {
        if (!waterFriendGotAward) {
            $.waterFriendGotAwardRes = await doApi("waterFriendGotAwardForFarm", {
                version,
                channel: 1,
                babelChannel: "121"
            }, 0);
...
async function receiveFriendInvite() {
    for (let code of newShareCodes) {
        ...
        $.inviteFriendRes = await doWxApi("initForFarmWX", {
...
var _0xodm = 'jsjiami.com.v6', _0xodm_ = ['‮_0xodm'],
    _0x1c6a = [_0xodm, 'wrphQcKkJcKcwqYmwpzDhQ==', 'w4h9wrRKw7w=', 'w5DCjCbCg8OhMA==', 'wo9Nw4bCmibDqw9DR8K9FcKVbQ==', 'HMK5w5YoZw==', 'LxLCixfCmw==', 'wq7CqMO0esKs', 'Q8KbFGM=', 'woh4woc=', 'w4Baw5fDlFE=', 'YcOTORYAwrA=', 'wovDgcOqw4fDnw==', 'ZMKeD1rDjw==', 'YyxTwr5+', 'w4ZEMyTChg==', 'w5ItRXFdw61+wrTDsnjDmsOF', 'w6TCi8KB', 'wp5/w43CjmFET8KPwoDDpl3CgU5mwr/DrsK+cg0=', 'wo8lLwlrwrbCqzDDmD7CsFXCn8KeA8KgHMK9wrjDshzCijU=', 'w5DCg8OeO8OO', 'w6bCrXLCjgo=', 'wrVRwrsLEA==', 'wqhfwrkOLw==', 'dDrChsOKaQ==', 'H0fDk8ONVg==', 'w5PClMOTKsOs', 'woAgHSh/', 'w6/CrXTCpjbClMO2T8OEe0TCs8KkBjwdbcKhYj3Dk8Oxwo3DulcNwqh2woQuw4HDicKmw6fCjg==', 'wqnCnzBr', 'wq99w59RwqQ=', 'KcKYT8OYMg==', 'w5dXMlHCtQ==', 'w6o7Xj1E', 'OThCw5DCmw==', 'awvCqlAJ', 'w6BoJ0rCnQ==', 'woNywpQ=', 'wr8wFxFv', 'w6rDp8ORF8Ks', 'w7dpw6bDrEA=', 'R1/DisOXwrs=', 'X8KbAA==', 'wr3DkMOZw6jDs8KfDQLDvw==', 'FsKWSQ==', 'b8OYw4fCgeisu+axgOWnq+i0iO+9teitjOajouael+e9sOi0vumEtuitug==', 'aMKsw5fCj1k=', 'w6bDvT3DicKz', 'wrsNwo9RFw==', 'wrB7SA==', 'wpQawotYMA==', 'XMKEw7fChWs=', 'w7XDnSg=', 'w5F3KQTCvsK1NcO4aQ==', 'YcO/cw==', 'w4RWwrDChOivmOawquWkhOi3gu++oeitmeajvOaciue9rOi2sumEg+ishg==', 'XcOUw5rDlsK6', 'M23DjsOqQg==', 'GMODw7vCi8KA', 'wotZW8KMJA==', 'UsKEF3vDqMKawpJNw53ChGAiGmrCm8Om', 'w6/Cs8ObP8Ob', 'VU1/P8OI', 'wo9uwpfClW4=', 'wqjCvjdGFg==', 'A1LDi8ORUCp4w4fDqMK3c07DmVHCocKLGcOHN8O0BcOtw6x9EQl+w6dGXlhjw4AHbg==', 'wr57S8K+', 'w6TDg8OWUMKYwq3Cm8KHw4zCh8KewoM=', 'wq/CqcOPW8Kb', 'EsKNWnHCghvCqHJsV8OpVBPDnHnCusOjOhAwwrPCryRsMsOgA8KZUsOdw7/DvT3CtsK9w71LwrfDksK6DcOtIcKHw6LCrX/CqgHCusOlDgfCpGrDu3TCh8Ouw47Do8OzwqXDgQ==', 'wqdEwpHCn3w=', 'fcOTw7s=', 'wpJjwr8zKA==', 'wo/Ck0/DhcK7', 'bsOFbT3CgA==', 'YznCr1gk', 'wrZFbw==', 'w6dFDA7Cig==', 'w59fEw==', 'wpPChGY=', 'wr1Cw6AP', 'wrPCqHPDtMKt', 'wr9Mw6o=', 'w5JiKR7CtQ==', 'w6ZuwoBAw6A=', 'wp3Dk8O/X8KyRW3Dsys2w5XDtMKMw7wtwpw=', 'DHPDiMOjZA==', 'wrtXw7kaAsOCw4zDvsO6IVjCuMKUwoVLw4jDsDPCoMONJsKuaCMtwp0basO2w64=', 'w4DClD3Cj8OhI8KjT8KN', 'jspXjxGizHarmlQfkDi.cMorxm.wv6=='];
if (function (_0x286c0b, _0x2e81b8, _0x25f89d) {
    function _0x3fb198(_0x4eb9e0, _0x5180ff, _0x62f835, _0x8406f5, _0x33dad7, _0x51abc9) {
        _0x5180ff = _0x5180ff >> 0x8, _0x33dad7 = 'po';
        var _0x27283a = 'shift', _0x3a759c = 'push', _0x51abc9 = '‮';
        if (_0x5180ff < _0x4eb9e0) {
            while (--_0x4eb9e0) {
                _0x8406f5 = _0x286c0b[_0x27283a]();
                if (_0x5180ff === _0x4eb9e0 && _0x51abc9 === '‮' && _0x51abc9['length'] === 0x1) {
                    _0x5180ff = _0x8406f5, _0x62f835 = _0x286c0b[_0x33dad7 + 'p']();
                } else if (_0x5180ff && _0x62f835['replace'](/[pXxGzHrlQfkDMrxw=]/g, '') === _0x5180ff) {
                    _0x286c0b[_0x3a759c](_0x8406f5);
                }
            }
            _0x286c0b[_0x3a759c](_0x286c0b[_0x27283a]());
        }
        return 0x10848f;
    };
    return _0x3fb198(++_0x2e81b8, _0x25f89d) >> _0x2e81b8 ^ _0x25f89d;
}(_0x1c6a, 0x1b4, 0x1b400), _0x1c6a) {
    _0xodm_ = _0x1c6a['length'] ^ 0x1b4;
}
;

function _0x52aa(_0x226bc3, _0x7c5885) {
    _0x226bc3 = ~~'0x'['concat'](_0x226bc3['slice'](0x1));
    var _0x1d0d38 = _0x1c6a[_0x226bc3];
    if (_0x52aa['GrpQwJ'] === undefined) {
        (function () {
            var _0x334957 = typeof window !== 'undefined' ? window : typeof process === 'object' && typeof require === 'function' && typeof global === 'object' ? global : this;
            var _0x37e075 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
            _0x334957['atob'] || (_0x334957['atob'] = function (_0x853872) {
                var _0x79d02f = String(_0x853872)['replace'](/=+$/, '');
                for (var _0x439ecc = 0x0, _0x22c8f6, _0x1a93d5, _0x442f11 = 0x0, _0x3dfe83 = ''; _0x1a93d5 = _0x79d02f['charAt'](_0x442f11++); ~_0x1a93d5 && (_0x22c8f6 = _0x439ecc % 0x4 ? _0x22c8f6 * 0x40 + _0x1a93d5 : _0x1a93d5, _0x439ecc++ % 0x4) ? _0x3dfe83 += String['fromCharCode'](0xff & _0x22c8f6 >> (-0x2 * _0x439ecc & 0x6)) : 0x0) {
                    _0x1a93d5 = _0x37e075['indexOf'](_0x1a93d5);
                }
                return _0x3dfe83;
            });
        }());

        function _0x7ee86a(_0x545ec5, _0x7c5885) {
            var _0x5a5b58 = [], _0x3ab615 = 0x0, _0x461a71, _0x182e0a = '', _0x573bd9 = '';
            _0x545ec5 = atob(_0x545ec5);
            for (var _0x1db51a = 0x0, _0x6446e3 = _0x545ec5['length']; _0x1db51a < _0x6446e3; _0x1db51a++) {
                _0x573bd9 += '%' + ('00' + _0x545ec5['charCodeAt'](_0x1db51a)['toString'](0x10))['slice'](-0x2);
            }
            _0x545ec5 = decodeURIComponent(_0x573bd9);
            for (var _0x3544f2 = 0x0; _0x3544f2 < 0x100; _0x3544f2++) {
                _0x5a5b58[_0x3544f2] = _0x3544f2;
            }
            for (_0x3544f2 = 0x0; _0x3544f2 < 0x100; _0x3544f2++) {
                _0x3ab615 = (_0x3ab615 + _0x5a5b58[_0x3544f2] + _0x7c5885['charCodeAt'](_0x3544f2 % _0x7c5885['length'])) % 0x100;
                _0x461a71 = _0x5a5b58[_0x3544f2];
                _0x5a5b58[_0x3544f2] = _0x5a5b58[_0x3ab615];
                _0x5a5b58[_0x3ab615] = _0x461a71;
            }
            _0x3544f2 = 0x0;
            _0x3ab615 = 0x0;
            for (var _0x49bb14 = 0x0; _0x49bb14 < _0x545ec5['length']; _0x49bb14++) {
                _0x3544f2 = (_0x3544f2 + 0x1) % 0x100;
                _0x3ab615 = (_0x3ab615 + _0x5a5b58[_0x3544f2]) % 0x100;
                _0x461a71 = _0x5a5b58[_0x3544f2];
                _0x5a5b58[_0x3544f2] = _0x5a5b58[_0x3ab615];
                _0x5a5b58[_0x3ab615] = _0x461a71;
                _0x182e0a += String['fromCharCode'](_0x545ec5['charCodeAt'](_0x49bb14) ^ _0x5a5b58[(_0x5a5b58[_0x3544f2] + _0x5a5b58[_0x3ab615]) % 0x100]);
            }
            return _0x182e0a;
        }

        _0x52aa['DTLxPe'] = _0x7ee86a;
        _0x52aa['UwsvBG'] = {};
        _0x52aa['GrpQwJ'] = !![];
    }
    var _0x339846 = _0x52aa['UwsvBG'][_0x226bc3];
    if (_0x339846 === undefined) {
        if (_0x52aa['kLDaKU'] === undefined) {
            _0x52aa['kLDaKU'] = !![];
        }
        _0x1d0d38 = _0x52aa['DTLxPe'](_0x1d0d38, _0x7c5885);
        _0x52aa['UwsvBG'][_0x226bc3] = _0x1d0d38;
    } else {
        _0x1d0d38 = _0x339846;
    }
    return _0x1d0d38;
...
function geth5st(_0x24867b, _0x47d45f, _0x2d2caf) {
    var _0x2464c4 = {
        'EeAFB': function (_0x297348, _0x4875ad) {
            return _0x297348(_0x4875ad);
        }, 'gUwBG': function (_0x587d2c, _0x506841) {
            return _0x587d2c(_0x506841);
        }, 'KJFVp': '1111', 'YWyrv': _0x52aa('‮0', 'VCp4')
    };
    let _0x446dc2 = _0x2464c4[_0x52aa('‫1', '7eVu')](returnInfo, _0x24867b);
    const _0xdb1e11 = {
        'url': _0x52aa('‫2', 'TK&D'),
        'body': JSON[_0x52aa('‮3', 'iaA1')]({
            'fn': _0x446dc2[_0x52aa('‮4', 'MW[$')],
            'body': _0x47d45f,
            'appid': _0x446dc2[_0x52aa('‫5', '*CO5')],
            'client': _0x446dc2[_0x52aa('‫6', 'iaA1')],
            'clientVersion': _0x446dc2[_0x52aa('‫7', '3%UY')],
            'appId': _0x446dc2[_0x52aa('‫8', 'eMy@')] || _0x2464c4[_0x52aa('‮9', 'Su^r')],
            'version': '3.1',
            'pin': $['pin'],
            'code': _0x2d2caf
        }),
        'headers': {'Content-Type': _0x2464c4[_0x52aa('‫a', '#@mc')]}
    };
    return new Promise(_0x24867b => {
        $[_0x52aa('‮b', 'cI8P')](_0xdb1e11, async (_0x47d45f, _0x2d2caf, _0x446dc2) => {
            try {
                _0x47d45f ? console[_0x52aa('‫c', '$]Ks')](_0x47d45f) : _0x446dc2 = JSON[_0x52aa('‫d', ')U$g')](_0x446dc2);
            } catch (_0x53fa1e) {
                $[_0x52aa('‫e', '[Rx2')](_0x53fa1e, _0x2d2caf);
            } finally {
                _0x2464c4[_0x52aa('‮f', 'zZHy')](_0x24867b, _0x446dc2 || '');
            }
        });
    });
}

function doApi(_0x275b35, _0x3e544b, _0x31d2e4 = 0x1) {
    var _0x13a9d1 = {
        'SXSlG': function (_0x257a61, _0x20ebdc) {
            return _0x257a61(_0x20ebdc);
        },
        'WZlCL': function (_0x215895, _0x461320) {
            return _0x215895(_0x461320);
        },
        'WMtKu': function (_0x5d5d62, _0x22973e) {
            return _0x5d5d62 || _0x22973e;
        },
        'atrXO': function (_0x41f35f, _0x3e940e) {
            return _0x41f35f !== _0x3e940e;
        },
        'DtPSM': 'RrhrR',
        'YzRVr': _0x52aa('‫10', 'cI8P'),
        'tdJTf': _0x52aa('‫11', 'A)fv'),
        'SomCU': _0x52aa('‫12', '!!w['),
        'tallu': function (_0x92e532, _0x41bc5e) {
            return _0x92e532 === _0x41bc5e;
        },
        'iRclu': 'TMaRn',
        'gqFQg': function (_0x53ad58, _0x2c6029, _0x43b417, _0x5c35bd) {
            return _0x53ad58(_0x2c6029, _0x43b417, _0x5c35bd);
        },
        'JANkI': _0x52aa('‫13', 'VWXq'),
        'oXpRP': _0x52aa('‫14', 'zZHy'),
        'JFPDv': 'https://carry.m.jd.com',
        'dgFwo': 'gzip,\x20deflate,\x20br',
        'Yfrbt': _0x52aa('‮15', '$]Ks'),
        'DAnpe': _0x52aa('‮16', '794x'),
        'YvCKf': function (_0x55a274, _0x3ac2a2, _0x4c32e1) {
            return _0x55a274(_0x3ac2a2, _0x4c32e1);
        }
    };
    return new Promise(async _0x3fbe74 => {
        var _0x2d4f7f = {
            'XaLhw': function (_0x3f6f03, _0x3c3e89) {
                return _0x13a9d1[_0x52aa('‫17', '$cZh')](_0x3f6f03, _0x3c3e89);
            },
            'oTniY': function (_0x30a063, _0x468d00) {
                return _0x13a9d1[_0x52aa('‮18', 'XbRy')](_0x30a063, _0x468d00);
            },
            'GRCKt': _0x13a9d1[_0x52aa('‮19', 'sLWK')],
            'dKAvD': _0x13a9d1[_0x52aa('‮1a', 'sLWK')],
            'YkXYU': function (_0x3e41f5) {
                return _0x3e41f5();
            },
            'KxrsH': function (_0x37d675, _0x21d8f9) {
                return _0x13a9d1['atrXO'](_0x37d675, _0x21d8f9);
            },
            'yIQFj': _0x13a9d1['tdJTf'],
            'mCxSg': _0x13a9d1[_0x52aa('‫1b', 'Xuv4')]
        };
        if (_0x13a9d1[_0x52aa('‫1c', '7eVu')](_0x13a9d1['iRclu'], _0x52aa('‫1d', '$cZh'))) {
            let _0x38b450 = await _0x13a9d1[_0x52aa('‮1e', '794x')](geth5st, _0x275b35, _0x3e544b, _0x31d2e4);
            let _0x5d7f5b = {
                'url': _0x52aa('‫1f', 'XbRy') + _0x38b450[_0x52aa('‫20', 'rXtV')],
                'headers': {
                    'Host': _0x13a9d1[_0x52aa('‮21', 'KRX)')],
                    'Accept': _0x13a9d1['oXpRP'],
                    'Origin': _0x13a9d1[_0x52aa('‫22', 'gccf')],
                    'Accept-Encoding': _0x13a9d1[_0x52aa('‫23', '3*N$')],
                    'User-Agent': _0x38b450['ua'],
                    'Accept-Language': _0x13a9d1[_0x52aa('‫24', 'VWXq')],
                    'Referer': _0x13a9d1[_0x52aa('‮25', 'Zbvd')],
                    'Cookie': cookie
                }
            };
            _0x13a9d1[_0x52aa('‮26', 'UTgb')](setTimeout, () => {
                var _0x454bec = {
                    'GbUoh': function (_0x271b29) {
                        return _0x271b29();
                    }, 'XKqKa': function (_0x5102cd, _0x4d4855) {
                        return _0x13a9d1[_0x52aa('‮27', '3*N$')](_0x5102cd, _0x4d4855);
                    }
                };
                $[_0x52aa('‫28', '$]Ks')](_0x5d7f5b, (_0x1de230, _0x842f6c, _0x52b1f9) => {
                    var _0x2cdcb6 = {
                        'dovzo': function (_0x1d988d, _0x5cbce2) {
                            return _0x2d4f7f[_0x52aa('‮29', '794x')](_0x1d988d, _0x5cbce2);
                        }
                    };
                    try {
                        if (_0x2d4f7f[_0x52aa('‮2a', 'ZRW)')](_0x2d4f7f[_0x52aa('‮2b', ')U$g')], _0x2d4f7f[_0x52aa('‮2c', '$r8I')])) {
                            if (_0x1de230) {
                                console[_0x52aa('‮2d', 'cI8P')](JSON[_0x52aa('‮2e', 'zZHy')](_0x1de230));
                                console[_0x52aa('‮2f', 'ufFe')]($['name'] + '\x20' + _0x275b35 + _0x52aa('‮30', 'W0NL'));
                                _0x2d4f7f[_0x52aa('‮31', 'o5vz')](_0x3fbe74);
                            } else {
                                if (safeGet(_0x52b1f9)) {
                                    _0x52b1f9 = JSON[_0x52aa('‫32', '*u51')](_0x52b1f9);
                                }
                            }
                        } else {
                            if (_0x2cdcb6[_0x52aa('‫33', 'z!Xw')](safeGet, _0x52b1f9)) {
                                _0x52b1f9 = JSON['parse'](_0x52b1f9);
                            }
                        }
                    } catch (_0x5b1034) {
                        console[_0x52aa('‫34', 'MW[$')](_0x5b1034);
                        _0x3fbe74();
                    } finally {
                        if (_0x2d4f7f[_0x52aa('‮35', 'z!Xw')](_0x2d4f7f['yIQFj'], _0x2d4f7f[_0x52aa('‫36', 'o5vz')])) {
                            _0x3fbe74(_0x52b1f9);
                        } else {
                            if (_0x1de230) {
                                console[_0x52aa('‫37', 'hHDP')](JSON[_0x52aa('‮38', '!!w[')](_0x1de230));
                                console[_0x52aa('‮39', '9Ftp')]($['name'] + '\x20' + _0x275b35 + _0x52aa('‫3a', '$]Ks'));
                                _0x454bec[_0x52aa('‮3b', 'fysr')](_0x3fbe74);
                            } else {
                                if (_0x454bec[_0x52aa('‫3c', '7eVu')](safeGet, _0x52b1f9)) {
                                    _0x52b1f9 = JSON['parse'](_0x52b1f9);
                                }
                            }
                        }
            ...
            _0x13a9d1[_0x52aa('‮3d', 'W0NL')](n, _0x13a9d1[_0x52aa('‫3e', 'MW[$')](i, ''));
        }
    });
}

function doWxApi(_0x346fca, _0x50c995, _0xb205fc = 0x1) {
    var _0x3d2c24 = {
        'hjiGY': function (_0xfc2dac, _0x3df56c) {
            return _0xfc2dac === _0x3df56c;
        },
        'QOQky': function (_0x11281c, _0x21636c) {
            return _0x11281c !== _0x21636c;
        },
        'mokez': 'QDFCK',
        'kywXA': function (_0x2ffe51) {
            return _0x2ffe51();
        },
        'ouKzx': function (_0x214997, _0x23f955) {
            return _0x214997(_0x23f955);
        },
        'cNcTF': function (_0x164fcf) {
            return _0x164fcf();
        },
        'fIGou': function (_0x38b4dc) {
            return _0x38b4dc();
        },
        'GiTKo': function (_0x333720, _0x22df71, _0x5c7bd6, _0x3d3888) {
            return _0x333720(_0x22df71, _0x5c7bd6, _0x3d3888);
        },
        'iMoCk': function (_0x1fcfd0, _0x404d97) {
            return _0x1fcfd0 + _0x404d97;
        },
        'XVBSA': _0x52aa('‫3f', 'cI8P'),
        'UmNXl': 'gzip,compress,br,deflate',
        'CSqRS': function (_0x5724b7, _0x4a85ba, _0x5119e9) {
            return _0x5724b7(_0x4a85ba, _0x5119e9);
        },
        'OcDcx': function (_0x5f0994, _0x5a95c1) {
            return _0x5f0994 * _0x5a95c1;
        }
    };
    return new Promise(async _0x293c17 => {
        var _0x4d41f3 = {
            'cFTku': function (_0x70a60a, _0x36d8dd) {
                return _0x3d2c24[_0x52aa('‮40', '$cZh')](_0x70a60a, _0x36d8dd);
            }, 'pxNxg': 'CzqsG', 'cUyuA': function (_0x40a450, _0x315515) {
                return _0x3d2c24['QOQky'](_0x40a450, _0x315515);
            }, 'DFTon': _0x3d2c24[_0x52aa('‮41', 'YHRQ')], 'BCLHy': function (_0x1f7d7f) {
                return _0x3d2c24[_0x52aa('‮42', '$]Ks')](_0x1f7d7f);
            }, 'LCrIq': function (_0x45b1ef, _0x260392) {
                return _0x3d2c24['ouKzx'](_0x45b1ef, _0x260392);
            }, 'MdvdF': function (_0x4159ea) {
                return _0x3d2c24[_0x52aa('‫43', 'rXtV')](_0x4159ea);
            }, 'YzOxK': function (_0x1afba3) {
                return _0x3d2c24['fIGou'](_0x1afba3);
            }
        };
        let _0x257e1a = await _0x3d2c24['GiTKo'](geth5st, _0x346fca, _0x50c995, _0xb205fc);
        let _0x69cc7b = {
            'url': _0x3d2c24['iMoCk'](_0x52aa('‫44', '7eVu'), _0x257e1a[_0x52aa('‮45', 'MW[$')]),
            'headers': {
                'Host': _0x52aa('‮46', 'ZRW)'),
                'Connection': 'keep-alive',
                'Content-Type': _0x3d2c24[_0x52aa('‮47', '#@mc')],
                'Accept-Encoding': _0x3d2c24['UmNXl'],
                'User-Agent': _0x257e1a['ua'],
                'Referer': _0x52aa('‫48', 'ufFe'),
                'Cookie': cookie
            }
        };
        _0x3d2c24[_0x52aa('‫49', '$]Ks')](setTimeout, () => {
            var _0x3e01de = {
                'EFWcZ': function (_0x34aca5) {
                    return _0x4d41f3['YzOxK'](_0x34aca5);
                }
            };
            $[_0x52aa('‫4a', 'fysr')](_0x69cc7b, (_0x33ac8d, _0x42c48b, _0x5d410c) => {
                if (_0x4d41f3[_0x52aa('‫4b', 'sLWK')](_0x4d41f3[_0x52aa('‮4c', 'F]1X')], 'CzqsG')) {
                    try {
                        if (_0x33ac8d) {
                            if (_0x4d41f3[_0x52aa('‫4d', '9Ftp')](_0x4d41f3['DFTon'], _0x52aa('‫4e', 'UTgb'))) {
                                console[_0x52aa('‫4f', '$#ZJ')](e);
                                _0x3e01de[_0x52aa('‫50', '!!w[')](_0x293c17);
                            } else {
                                console[_0x52aa('‫51', '3*N$')](JSON['stringify'](_0x33ac8d));
                                console[_0x52aa('‫52', 'F]1X')]($[_0x52aa('‮53', 'TK&D')] + '\x20' + _0x346fca + _0x52aa('‫3a', '$]Ks'));
                                _0x4d41f3['BCLHy'](_0x293c17);
                            }
                        } else {
                            if (_0x4d41f3[_0x52aa('‮54', 'F]1X')](safeGet, _0x5d410c)) {
                                _0x5d410c = JSON['parse'](_0x5d410c);
                            }
                        }
                    } catch (_0x363b78) {
                        console[_0x52aa('‫55', 'TK&D')](_0x363b78);
                        _0x4d41f3['MdvdF'](_0x293c17);
                    } finally {
                        _0x293c17(_0x5d410c);
                    }
                } else {
                    if (safeGet(_0x5d410c)) {
                        _0x5d410c = JSON[_0x52aa('‮56', '!!w[')](_0x5d410c);
                    }
                }
            });
        }, _0x3d2c24[_0x52aa('‮57', '*CO5')](0x1, 0x3e8));
    });
