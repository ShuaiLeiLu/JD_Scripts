...
[task_local]
#35.31-6.8 时尚狂欢盛典
55 3,16 21-27 3 * jd_opencardL164.js, tag=3.21-3.27 春日风尚 入会焕新, enabled=true

*/
const $ = new Env("5.31-6.8 时尚狂欢盛典");
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      authorCodeList = [
        "b8c3af811ec24326b88601174402ba56","f572bf2025074b68b495742c73fa3a9a","8567fc8031e94d5da8759a3806180946",
      ];
