...
let strGuoqi="";
let RemainMessage = '\n';
RemainMessage += "⭕羊毛攻略(请仔细阅读一遍):⭕" + '\n';
RemainMessage += '【极速金币】京东极速版->我的->金币(极速版使用),京东购物无门槛抵扣\n';
RemainMessage += '【京东赚赚】微信->京东赚赚小程序->底部赚好礼->提现无门槛红包(京东使用)\n';
RemainMessage += '【京东秒杀】京东->中间频道往右划找到京东秒杀->中间点立即签到->兑换无门槛红包(京东使用)\n';
RemainMessage += '【东东萌宠】京东->我的->东东萌宠,完成是京东红包,可以用于抵扣京东app的任意商品\n';
RemainMessage += '【领现金】京东->我的->东东萌宠->领现金(微信提现+京东红包)\n';
RemainMessage += '【东东农场】京东->我的->东东农场,完成是京东红包,可以用于抵扣京东app的任意商品\n';
